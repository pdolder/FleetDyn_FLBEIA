...
the remaining catches were aggregated into a "COD\_fleet", "HAD\_fleet" etc..
This approach ensured that any differences observed between scenarios was down
to the choice of location model for the Irish otter trawl fleet only. \\
